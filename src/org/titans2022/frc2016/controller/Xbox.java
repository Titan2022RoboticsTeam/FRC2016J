...
public class Xbox extends Joystick {
	...
	public static final int TRIGGERS_LEFT = 2;
	public static final int TRIGGERS_RIGHT = 3;
	// Buttons
	 ...
	 *
	 * @param port
	 *            The port on the drivers station that the controller is
	 *            connected to
	 * @return
	 */
	 ...
	 *
	 * @param reflectCircle
	 *            Choose whether to reflect over the Y axis.
	...
	//////////////// Get Raw Button Methods to be used by Command/Subsystem
	//////////////// Interface
	/**
	 * Get A Button
	 *
	 ...
	 *
	 * @param button
	 *            The button to get the value of. Range 1-10.
	 ...
	 *
	 * @param axis
	 *            The axis to get the value of. Range 1-6.
	 * @return The value of the axis from -1 to 1.
	 */
